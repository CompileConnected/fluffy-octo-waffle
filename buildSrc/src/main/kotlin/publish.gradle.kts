    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/compileconnected/fluffyoctowaffle/")
                ...
                developers {
                    developer {
                        id.set("compileconnected")
                        name.set("compileconnected")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/compileconnected/fluffyoctowaffle.git")
                    developerConnection.set("scm:git:ssh://github.com/compileconnected/fluffyoctowaffle.git")
                    url.set("https://github.com/compileconnected/fluffyoctowaffle/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/compileconnected/fluffyoctowaffle/issues")
                }
            }
        }
    }
